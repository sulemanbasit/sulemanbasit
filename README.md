...
Data analyst working with Python, SQL, and Tableau to turn raw data into actionable insights. I build pipelines, dashboards, and tools that make data easier to work with.
...
- Writing Python scripts and SQL queries to clean and transform data
